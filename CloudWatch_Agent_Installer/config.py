...
WINDOWS_INIT_AGENT_COMMAND = "C:\Program Files\Amazon\AmazonCloudWatchAgent\amazon-cloudwatch-agent-ctl.ps1 -a fetch-config -m ec2 -c file:C:\Program Files\Amazon\AmazonCloudWatchAgent\amazon-cloudwatch-agent.json -s"
